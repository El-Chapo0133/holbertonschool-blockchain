 ...
 * ==========================================================================
 *
 *       Filename:  transaction_create.c
 *
 *    Description:  creates a transaction
 *
 *        Version:  1.0
 *        Created:  11.04.2025 10:03:09
 *       Revision:  none
 *       Compiler:  gcc
 *
 ...
 * @amount: amout to send
 * @all_unspent: llist of all unspent outputs
 *
 * Return: newly created transaction or NULL
 */
